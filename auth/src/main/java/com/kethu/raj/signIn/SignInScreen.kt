...
import com.kethu.raj.navigation.ForgotPassword
    ...
    AuthScreenTemplate(
        ...
        UiButton(
            ...
            properties = ButtonUiDataModel(
                ...
                onAction(SignInEvent.DoLogin(context, userName, password))
            })
        ...
        when {
            uiState.value.isSignInSuccess -> (context as? Activity)?.finishAffinity()
